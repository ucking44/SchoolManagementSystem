...
<div class="sb2-13">
    <ul class="collapsible" data-collapsible="accordion">
        ...
        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-user" aria-hidden="true"></i> Users</a>
            <div class="collapsible-body left-sub-menu">
                <ul>
                    <li><a href="admin-user-all.html">Admin</a>
                    </li>
                    <li><a href="{{ route('teacher.index') }}">Teacher</a>
                    </li>
        ...
        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-bookmark-o" aria-hidden="true"></i>All Pages</a>
            <div class="collapsible-body left-sub-menu">
                <ul>
                    <li><a href="{{ route('class.index') }}">Class</a>
                    </li>
                    <li><a href="{{ route('admission.index') }}">Admission</a>
                    </li>
                    <li><a href="{{ route('academic.index') }}">Academic</a>
                    </li>
                    <li><a href="{{ route('batch.index') }}">Batch</a>
                    </li>
                    <li><a href="{{ route('faculty.index') }}">Faculty</a>
                    </li>
                    <li><a href="{{ route('department.index') }}">Department</a>
                    </li>
                    <li><a href="{{ route('course.index') }}">Course</a>
                    </li>
                    <li><a href="{{ route('level.index') }}">Level</a>
                    </li>
                    <li><a href="{{ route('day.index') }}">Day</a>
                    </li>
                    <li><a href="{{ route('shift.index') }}">Shift</a>
                    </li>
                    <li><a href="{{ route('time.index') }}">Time</a>
                    </li>
                    <li><a href="{{ url('feestructure') }}">Fee Structure</a>
                    </li>
                    <li><a href="{{ url('classAssigning') }}">Class Assigning</a>
                    </li>
                    <li><a href="{{ route('semester.index') }}">Semester</a>
                    </li>
                    <li><a href="{{ route('classroom.index') }}">Class Room</a>
                    </li>
                    <li><a href="{{ route('classScheduling.index') }}">Class Scheduling</a>
                    </li>
        ...
        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-users" aria-hidden="true"></i> Students</a>
            <div class="collapsible-body left-sub-menu">
                <ul>
                    <li><a href="{{ route('student.index') }}">All Students</a>
                    </li>
