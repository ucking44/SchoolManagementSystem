...
<div class="modal fade left" id="addAcademicModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-notify modal-md modal-right" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-sun-o" aria-hidden="true"> Ad</i>d New Fee</h5>
            ...
            <form class="needs-validation" novalidate="" action="{{ route('academic.store') }}" method="post">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="status" class="custom-control-input" id="customCheck1" value="enable" required>
...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <a href="{{ route('academic.create') }}" style="float: right" class="btn btn-primary" data-toggle="modal" data-target="#addAcademicModal">Create Academic Session</a>
            <br/>
            <br/>
            <div class="row">
                <div class="col-12">
