        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                {{-- <div class="card-header card-header-primary">
                    <h4 class="card-title "><b>Add New Department</b></h4>
                </div> --}}
                ...
                <form action="{{ route('department.store') }}" id="company-form" method="POST">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 mt-3">
                                ...
                                <textarea class="form-control" name="department_description" id="department_description" rows="4" required=""></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-3 mt-3">
                            ...
                            <br/>
                            {{-- <div class="controls"> --}}
                              <input type="checkbox" name="department_status" id="enable" value="enable">
                            {{-- </div> --}}
                        </div>
