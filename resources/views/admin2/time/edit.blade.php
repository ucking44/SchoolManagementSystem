        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                {{-- <div class="card-header card-header-primary">
                    <h4 class="card-title "><b>Add New Time Year</b></h4>
                </div> --}}
                ...
                <form action="{{ route('time.update', $time->id) }}" id="company-form" method="POST">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input type="text" name="time" id="time" class="form-control" value="{{ $time->time }}">
                            </div>
                        </div>
                    </div>
