                ...
                <form action="{{ route('admission.store') }}" id="company-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-4 mt-3">
                                ...
                                <select class="form-control" name="batch" required>
                                    @foreach($batches as $batch)
                                        <option value="{{ $batch->batch }}">{{ $batch->id }}</option>
                                    @endforeach
                                </select>
                            </div> --}}
                            ...
                            <div class="col-4 mt-3">
                                <label for="localOfOrigin">Local Of Origin</label>
                                <input type="text" name="localOfOrigin" id="localOfOrigin" class="form-control" required>
                            </div>

                            <div class="col-4 mt-3">
                                <label for="stateOfOrigin">State Of Origin</label>
                                <input type="text" name="stateOfOrigin" id="stateOfOrigin" class="form-control" required>
                            </div>
