    ...
    <!-- /.content-header -->
        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                ...
                <form action="{{ route('student.update', $student->id) }}" id="company-form" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12" >
                                ...
                                <input type="text" name="fullname" id="fullname" class="form-control" value="{{ $student->fullname }}">
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea class="form-control" name="address" id="address" rows="4">{{ $student->address }}</textarea>
                            </div>
                        ...
                        {{-- <div class="col-3 mt-3">
                            ...
                            <br/>
                              <input type="checkbox" name="status" id="status" {{ $student->status == "enable" ? 'checked' : '' }}>
                        </div> --}}
