    ...
    <!-- /.content-header -->
        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                ...
                <form action="{{ route('prosstudent.store') }}" id="company-form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-3 mt-3">
                                ...
                                <input type="text" name="localOfOrigin" id="localOfOrigin" class="form-control">
                            </div>
