        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                {{-- <div class="card-header card-header-primary">
                    <h4 class="card-title "><b>Add New Shift Year</b></h4>
                </div> --}}
                ...
                <form action="{{ route('shift.update', $shift->id) }}" id="company-form" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input type="text" name="shift" id="shift" class="form-control" value="{{ $shift->shift }}">
                            </div>
                        </div>
                    </div>
