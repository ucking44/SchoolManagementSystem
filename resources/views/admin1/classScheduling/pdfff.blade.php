                                        ...
                                        <tbody>
                                            @foreach($class_schedulings as $class_scheduling)
                                                <tr>
                                                    ...
                                                    <span class="names">Class:</span> {{ $class_scheduling->class->class_name }}
                                                    </td>
                                                    <div class="v"></div>
                                                    ...
                                                    <span class="names">Level:</span> {{ $class_scheduling->level->level }}
                                                    <span class="names">Course:</span> {{ $class_scheduling->course->course_name }} |
