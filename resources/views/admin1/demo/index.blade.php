...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ route('day.create') }}" class="btn btn-primary">Create Day</a>
                    @include('layouts.backend.partials.msg')
                        <div class="card">
                            <div class="card-header card-header-primary">
                            <h4 class="card-title "><b>All Days</b></h4>
                                            ...
                                            @foreach ($periods as $key => $day)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        <button class="btn btn-info btn-sm"><a href="{{ route('day.edit', $day->id) }}">
