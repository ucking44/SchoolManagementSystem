...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="UcKing : Education Application" />

	<!-- OG -->
	<meta property="og:title" content="UcKing : Education Application" />
	<meta property="og:description" content="UcKing : Education Application" />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>UcKing : Education Application </title>
				...
				<div class="row d-flex justify-content-between">
					<div class="topbar-left">
						<ul>
							...
							<li><a href="javascript:;"><i class="fa fa-envelope-o"></i>ucking4niga@yahoo.com</a></li>
						</ul>
					</div>
					<div class="topbar-right">
						<ul>
                            ...
                            @if(Session::has('studentSession'))
                                <li><a href="{{ URL::to('/account') }}" >{{ __('languages.account') }}</a>
                                </li>
                                <li><a href="{{ URL::to('/logout') }}">{{ __('languages.logout') }}</a>
                                </li>
                                <div class="top-right links">
                                    <a href="locale/en">{{ __('languages.english') }}<img src="{{ asset('language_images/england.jpg') }}" alt="" srcset="" style="width: 35px"></a>
                                    <a href="locale/fr">{{ __('languages.french') }}<img src="{{ asset('language_images/france.png') }}" alt="" srcset="" style="width: 35px"></a>
                                    <a href="{{ ('locale/ger') }}">{{ __('languages.germany') }}<img src="{{ asset('language_images/germany.png') }}" alt="" srcset="" style="width: 35px"></a>
                                    <a href="{{ ('locale/esp') }}">{{ __('languages.spain') }}<img src="{{ asset('language_images/spain.png') }}" alt="" srcset="" style="width: 35px"></a>
                                    <a href="{{ ('locale/chi') }}">{{ __('languages.china') }}<img src="{{ asset('language_images/china.png') }}" alt="" srcset="" style="width: 35px"></a>
                                </div>
                            @else
                                <li><a href="{{ URL::to('/login-student') }}">{{ __('languages.login') }}</a>
                                </li>
                                <div class="top-right links">
                                    <a href="locale/en">{{ __('languages.english') }}<img src="{{ asset('language_images/england.jpg') }}" alt="" srcset="" style="width: 35px"></a>
                                    <a href="locale/fr">{{ __('languages.french') }}<img src="{{ asset('language_images/france.png') }}" alt="" srcset="" style="width: 35px"></a>
                ...
                <div class="container clearfix">
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                        ...
                        <ul class="nav navbar-nav">
							<li class="active"><a href="javascript:;">{{ __('languages.home') }} <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									<li><a href="index.html">Home 1</a></li>
									<li><a href="index-2.html">Home 2</a></li>
								</ul>
							</li>
							<li><a href="javascript:;">{{ __('languages.pages') }} <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
							...
							<li class="add-mega-menu"><a href="javascript:;">{{ __('languages.our-courses') }} <i class="fa fa-chevron-down"></i></a>
                            ...
                            <li><a href="javascript:;">{{ __('languages.admission') }} <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									<li><a href="{{ route('admission.create') }}">Admission</a></li>
								</ul>
							</li>
							<li><a href="javascript:;">{{ __('languages.blog') }} <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
							...
							<li class="nav-dashboard"><a href="javascript:;">{{ __('languages.dashboard') }} <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Title   tp-resizeme"
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									Welcome To Uc King's University
							</div>
					...
					<div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                        <div class="widget widget_gallery gallery-grid-4">
                            ...
                            <ul class="magnific-image">
								<li><a href="assets/images/gallery/pic1.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic1.jpg') }}" alt=""></a></li>
								<li><a href="assets/images/gallery/pic2.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic2.jpg') }}" alt=""></a></li>
								<li><a href="assets/images/gallery/pic3.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic3.jpg') }}" alt=""></a></li>
								<li><a href="assets/images/gallery/pic4.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic4.jpg') }}" alt=""></a></li>
								<li><a href="assets/images/gallery/pic5.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic5.jpg') }}" alt=""></a></li>
								<li><a href="assets/images/gallery/pic6.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic6.jpg') }}" alt=""></a></li>
								<li><a href="assets/images/gallery/pic7.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic7.jpg') }}" alt=""></a></li>
