...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Uc King : Education Application </title>
				...
				<div class="row d-flex justify-content-between">
					...
					<div class="topbar-right">
						<ul>
                            ...
                            @else
                                <li><a href="{{ URL::to('/login-student') }}">Login</a>
                                </li>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							<div class="profile-bx text-center">
								<div class="user-profile-thumb">
                                    <img src="{{ asset('uploads/admission/' . $students->image) }}" alt="User Avatar">
								</div>
							...
							<div class="profile-content-bx">
								<div class="tab-content">
									...
									<div class="tab-pane" id="edit-profile">
										...
										<form class="edit-profile">
											<div class="">
												...
												<div class="form-group row">
													<label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Student Name</label>
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="{{ $students->first_name }} {{ $students->last_name }}" readonly>
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="email" value="{{ $students->email }}" readonly>
													</div>
												</div>
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="{{ $students->gender }}" readonly>
													</div>
												</div>
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="{{ $students->dob }}" readonly>
													</div>
												</div>

                                                <div class="form-group row">
													<label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Marrital Status</label>
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        @if ($students->status === "enable")
                                                        <input class="form-control" value="Single" readonly>
                                                        @else
                                                        <input class="form-control" value="Married" readonly>
                                                        @endif
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="{{ $students->phone }}" readonly>
													</div>
												</div>

                                                <div class="form-group row">
													<label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Date Registered</label>
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="{{ date("Y-m-d", strtotime ($students->dateregistered)) }}" readonly>
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="{{ $students->current_address }}" readonly>
													</div>
												</div>
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="{{ $students->nationality }}" readonly>
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="www.linkedin.com" readonly>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Facebook</label>
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="www.facebook.com" readonly>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Twitter</label>
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="www.twitter.com" readonly>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Instagram</label>
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
														<input class="form-control" type="text" value="www.instagram.com" readonly>
													</div>
												</div>
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        @if ($students->status === "enable")
                                                        <input class="form-control" style="font-size: 18px; color: green;" value="Active" readonly>
                                                        @else
                                                        <input class="form-control" style="font-size: 18px; color: red;" value="In-Active" readonly>
                                                        @endif
													</div>
												</div>
											</div>
											<div class="">
												<div class="">
													<div class="row">
														...
														<div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                            <button type="submit" class="btn"><a href="#">Edit Profile</a></button>
									...
									<div class="tab-pane" id="change-password">
										...
										<form class="edit-profile" action="{{ URL::to('/student-update-password') }}" method="POST">
                                            @csrf
											<div class="">
												<div class="form-group row">
											...
											<div class="row">
												...
												<div class="col-12 col-sm-8 col-md-8 col-lg-7">
													...
													{{-- <button type="submit" class="btn-secondry">Cancel</button> --}}
												</div>
											</div>
										</form>
									</div>
