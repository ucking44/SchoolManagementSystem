        ...
        <div class="pro-menu">
            <div class="container">
                <div class="col-md-9 col-md-offset-3">
                    <ul>
                        <li><a href="{{ URL::to('/account') }}">My Dashboard</a></li>
                        <li><a href="{{ URL::to('/student-biodata') }}">Profile</a></li>
                        <li><a href="{{ URL::to('/change-password') }}" class="pro-act">Change Password</a></li>
                        <li><a href="db-courses.html">Courses</a></li>
                        <li><a href="db-exams.html">Exams</a></li>
                        <li><a href="db-time-line.html">Time Line</a></li>
                                        ...
                                        <div class="col-md-12">
                                            <div class="box-inn-sp admin-form">
                                                    <div class="inn-title">
                                                        ...
                                                        <div>
                                                            <form action="{{ URL::to('/student-update-password') }}" method="POST">
                                                                @csrf
                                                                ...
                                                                <div>
                                                                    <div class="row">
                                                                        <div class="input-field col s6">
                                                                            ...
                                                                            <input type="password" name="old_password" id="oldpassword" value="" class="validate">
                                                                            <label class="">Old Password</label>
                                                                            <i class="input-icon" id="messageError"></i>
                                                                        </div>
                                                                        <div class="input-field col s6">
                                                                            <input type="password" name="new_password" id="newpassword" value="" class="validate">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="input-field col s12">
                                                                            <i class="waves-effect waves-light btn-large waves-input-wrapper" style="">Update Password<input type="submit" class="waves-button-input"></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
