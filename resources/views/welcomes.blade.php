                ...
                <div class="ed-mm-right">
                    <div class="ed-mm-menu">
                        ...
                        <div class="ed-mm-inn">
                            ...
                            <h4>All Pages</h4>
                            <ul>
                                <li><a href="{{ URL::to('/') }}">{{__('languages.home') }}</a></li>
                        ...
                        <div class="ed-com-t1-right">
                            <ul>
                                @if(Session::has('studentSession'))
                                    <li><a href="{{ URL::to('/account') }}" >Account</a>
                                    </li>
        ...
        <div id="modal1" class="modal fade" role="dialog">
            <div class="log-in-pop">
                ...
                <div class="log-in-pop-right">
                    ...
                    <h4>Login</h4>
                    <p>Don't have an account? Create your account. It takes less than a minute</p>
                    <form class="s12" action="{{ url('/student-login') }}" method="POST">
                        @csrf
                        <div>
                            <div class="input-field s12">
                                <input id="username" type="text" data-ng-model="name" class="form-control validate @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                        ...
                        <div>
                            ...
                            <a class="float-right" href="{{ URL::to('/register') }}">Register </a><br> --}}
